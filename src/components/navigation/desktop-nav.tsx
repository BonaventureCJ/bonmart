                        ...
                        <li key={link.id}>
                            <Link
                                ...
                                className={clsx(
                                    ...
                                    'after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 after:origin-center after:scale-x-0 after:rounded-full after:bg-brand-color after:transition-transform after:duration-long',
                                    'hover:text-brand',
                                    {
