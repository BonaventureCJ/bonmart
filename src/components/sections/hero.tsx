    ...
    return (
        ...
        >
            <div className={`mb-4 ${prefersReducedMotion ? "" : "animate-bounce"}`} aria-hidden={prefersReducedMotion}>
                <BonMartCartLogo className="w-[100px] h-[100px] text-(--brand-color)" />
            </div>
            ...
            <h2 className="text-2xl text-(--brand-color) mb-6">
                Bonzer & Green
            </h2>

            <p className="text-lg text-(--neutral-color) max-w-md">
                We are crafting something special just for you. Our new online store is under construction and will be live soon!
            </p>
            <p className="text-lg text-(--neutral-color) mb-8 max-w-md">
